...
namespace SRCTestForm
{
    ...
    internal partial class frmMain : IGUIStatus
    {
        ...
        public void DisplayPilotStatus(Pilot p)
        {
            ...
            var unit = DisplayedUnit;
            if (ReferenceEquals(p, unit.MainPilot()))
            {
                // メインパイロット
            ...
            {
                //// サブパイロット
                //var subPilot = unit.Pilots.FirstOrDefault(x => x == p);
                //if (subPilot != null)
                //{
                //    DisplayUnitStatus(DisplayedUnit, subPilot);
                //}

                //// サポートパイロット
                //var loopTo1 = unit.CountSupport();
                //for (i = 1; i <= loopTo1; i++)
                //{
                //    if (ReferenceEquals(p, unit.Support(i)))
                //    {
                //        DisplayUnitStatus(DisplayedUnit, (i + unit.CountPilot()));
                //        return;
                //    }
                //}
                ...
                //if (unit.IsFeatureAvailable(argfname))
                //{
                //    DisplayUnitStatus(DisplayedUnit, (unit.CountPilot() + unit.CountSupport() + 1));
                //}
            }
        }
