...
namespace SRC.Core.Pilots
{
    ...
    public class Pilots : IEnumerable
    {
        ...
        {
            return colPilots.Values.GetEnumerator();
        }

//        // パイロットを追加
//        public Pilot Add(string pname, int plevel, string pparty, [Optional, DefaultParameterValue("")] string gid)
//        {
...
//                    if (SRC.PList.IsDefined2(argIndex3))
//                    {
//                        Pilot localItem21() { object argIndex1 = key; var ret = SRC.PList.Item2(argIndex1); return ret; }

//                        if ((localItem21().ID ?? "") == (key ?? ""))
//                        {
//                            // 一度作成されたパイロットを復活させる場合
//                            Pilot localItem2() { object argIndex1 = key; var ret = SRC.PList.Item2(argIndex1); return ret; }

//                            if (!localItem2().Alive)
//                            {
//                                object argIndex1 = key;
//                                {
//                                    var withBlock = SRC.PList.Item2(argIndex1);
...
//                                AddRet = SRC.PList.Item2(argIndex2);
//                                return AddRet;
//                            }
...
//                    }
//                    while (SRC.PList.IsDefined2(argIndex4));
//                }
//            }
//            else
//            {
...
//                while (SRC.PList.IsDefined2(argIndex5))
//                {
//                    i = (i + 1);
