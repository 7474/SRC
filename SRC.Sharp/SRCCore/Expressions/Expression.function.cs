    ...
    public partial class Expression
    {
        ...
        public ValueType CallFunction(string expr, ValueType etype, out string str_result, out double num_result)
        {
            ...
            if (!isUserFunc)
            {
                ...
                {
                    var systemFunctionRet = systemFunc.Invoke(SRC, etype, @params, pcount, is_term, out str_result, out num_result); (expr, etype, fname, @params, pcount, is_term, out str_result, out num_result);
