                ...
                case "特殊能力レベル":
                    {
                        ...
                        if (u is object)
                        {
                            if (GeneralLib.IsNumber(aname))
                            {
                                double localFeatureLevel() { object argIndex1 = Conversions.ToInteger(aname); var ret = u.FeatureLevel(argIndex1); return ret; }

                                str_result = SrcFormatter.Format(localFeatureLevel());
                            }
                            else
                            {
                        ...
                        else if (ud is object)
                        {
                            if (GeneralLib.IsNumber(aname))
                            {
                                double localFeatureLevel2() { object argIndex1 = Conversions.ToInteger(aname); var ret = ud.FeatureLevel(argIndex1); return ret; }

                                str_result = SrcFormatter.Format(localFeatureLevel2());
                            }
                            else
                            {
                        ...
                        else if (p is object)
                        {
                            if (GeneralLib.IsNumber(aname))
                            {
                                double localSkillLevel() { object argIndex1 = Conversions.ToInteger(aname); string argref_mode = ""; var ret = p.SkillLevel(argIndex1, ref_mode: argref_mode); return ret; }

                                str_result = SrcFormatter.Format(localSkillLevel());
                            }
                            else
                            {
