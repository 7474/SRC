...
namespace SRCCore.Models
{
    ...
    public class MessageData
    {
        ...
        {
            var item = Items.FirstOrDefault(x => x.Situation == msg_situation);
            if (item != null)
            {
                return item.Message;
            }
            ...
            //            {
            //                Array.Resize(sub_situations, Information.UBound(sub_situations) + 1 + 1);
            //                sub_situations[Information.UBound(sub_situations)] = "(対弱点=" + GeneralLib.GetClassBundle(withBlock.strWeakness, i) + ")";
            //            }
            //        }
            ...
            //            {
            //                Array.Resize(sub_situations, Information.UBound(sub_situations) + 1 + 1);
            //                sub_situations[Information.UBound(sub_situations)] = "(対有効=" + GeneralLib.GetClassBundle(withBlock.strEffective, i) + ")";
            //            }
            //        }
