...
namespace Project1
{
    internal class MessageDataList
    {
        ...
        private Collection colMessageDataList = new Collection();
        ...
        private void Class_Terminate_Renamed()
        {
            short i;
            {
                var withBlock = colMessageDataList;
        ...
        // メッセージデータの追加
        public MessageData Add(ref string mname)
        {
            MessageData AddRet = default;
        ...
        public short Count()
        {
            ...
            CountRet = (short)colMessageDataList.Count;
            return CountRet;
        }
        ...
        // メッセージデータの検索
        public MessageData Item(ref object Index)
        {
            MessageData ItemRet = default;
            ;
#error Cannot convert OnErrorGoToStatementSyntax - see comment for details
            /* Cannot convert OnErrorGoToStatementSyntax, CONVERSION ERROR: Conversion for OnErrorGoToLabelStatement not implemented, please report this issue in 'On Error GoTo ErrorHandler' at character 1650
             ...
             */
            ItemRet = (MessageData)colMessageDataList[Index];
            return ItemRet;
        ErrorHandler:
            ;
        ...
        public bool IsDefined(ref object Index)
        {
            ...
            ;
#error Cannot convert OnErrorGoToStatementSyntax - see comment for details
            /* Cannot convert OnErrorGoToStatementSyntax, CONVERSION ERROR: Conversion for OnErrorGoToLabelStatement not implemented, please report this issue in 'On Error GoTo ErrorHandler' at character 2120
             ...
             */
            md = (MessageData)colMessageDataList[Index];
            IsDefinedRet = true;
            return IsDefinedRet;
        ErrorHandler:
            ;
