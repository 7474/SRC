...
#error Cannot convert OnErrorGoToStatementSyntax - see comment for details
        ...
        ErrorHandler:
            ;
            string argmsg = Name + "の" + "アビリティ「" + Data.Name + "」の" + "属性「" + attr + "」のレベル指定が不正です";
        ...
        public bool IsAbilityAvailable(string_mode)
        {
            ...
            {
                {
                    ...
                    string argattr15 = "音";
                    if (IsSpellAbility() | IsAbilityClassifiedAs(a, argattr15))
                    {
                        return IsAbilityAvailableRet;
                    }
                }
        ...
        public bool IsAbilityUseful(string_mode)
        {
        ...
        public bool IsTargetWithinAbilityRange(Unit t)
        {
            ...
            string argattr = "合";
            string argattr1 = "Ｍ";
            if (IsAbilityClassifiedAs(a, argattr) & !IsAbilityClassifiedAs(a, argattr1) & AbilityMaxRange() == 1)
            {
