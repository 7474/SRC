    ...
    public partial class Unit
    {
        ...
        FoundMessage:
            ...
            while (Strings.InStr(msg, "$(ユニット)") > 0)
            {
                ...
                msg = Strings.Left(msg, (int)(Conversions.ToDouble(idx) - 1d)) + buf + Strings.Mid(msg, (int)(Conversions.ToDouble(idx) + 7d));
            }
            ...
            while (Strings.InStr(msg, "$(機体)") > 0)
            {
                ...
                msg = Strings.Left(msg, (int)(Conversions.ToDouble(idx) - 1d)) + buf + Strings.Mid(msg, (int)(Conversions.ToDouble(idx) + 5d));
            }
            ...
            while (Strings.InStr(msg, "$(パイロット)") > 0)
            {
                ...
                msg = Strings.Left(msg, (int)(Conversions.ToDouble(idx) - 1d)) + buf + Strings.Mid(msg, (int)(Conversions.ToDouble(idx) + 8d));
            }
            ...
            if (Strings.InStr(msg, "$(武器)") > 0)
            {
                ...
                while (Strings.InStr(msg, "$(武器)") > 0)
                {
                    ...
                    msg = Strings.Left(msg, (int)(Conversions.ToDouble(idx) - 1d)) + wname + Strings.Mid(msg, (int)(Conversions.ToDouble(idx) + 5d));
                }
            }
            ...
            while (Strings.InStr(msg, "$(相手ユニット)") > 0)
            {
                ...
                msg = Strings.Left(msg, (int)(Conversions.ToDouble(idx) - 1d)) + buf + Strings.Mid(msg, (int)(Conversions.ToDouble(idx) + 9d));
            }
            ...
            while (Strings.InStr(msg, "$(相手パイロット)") > 0)
            {
                ...
                msg = Strings.Left(msg, (int)(Conversions.ToDouble(idx) - 1d)) + buf + Strings.Mid(msg, (int)(Conversions.ToDouble(idx) + 10d));
            }
