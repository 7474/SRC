...
//        public short CountAllFeature()
//        {
//            short CountAllFeatureRet = default;
//            CountAllFeatureRet = (short)colAllFeature.Count;
...
//                        if (Conversions.ToBoolean(Operators.ConditionalCompareObjectEqual(fname, withBlock[(int)i].Name, false)))
//                        {
...
//                    var loopTo = (short)withBlock4.Count;
//                    for (i = 1; i <= loopTo; i++)
//                        farray[i] = (FeatureData)withBlock4[i];
//                    var loopTo1 = (short)withBlock4.Count;
//                    for (i = 1; i <= loopTo1; i++)
//                        withBlock4.Remove(1);
