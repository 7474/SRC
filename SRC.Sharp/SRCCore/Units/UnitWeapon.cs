...
namespace SRCCore.Units
{
    ...
    public class UnitWeapon
    {
        ...
        public int WeaponMaxRange()
        {
            ...
            string argattr2 = "突";
            string argattr3 = "接";
            if (IsWeaponClassifiedAs(argattr1) | IsWeaponClassifiedAs(argattr2) | IsWeaponClassifiedAs(argattr3))
            {
                return WeaponMaxRangeRet;
            }
...
#error Cannot convert OnErrorGoToStatementSyntax - see comment for details
        ...
        public bool IsWeaponUseful(string ref_mode)
        {
            ...
            string argattr = "Ｍ扇";
            string argattr1 = "Ｍ移";
            if (IsWeaponClassifiedAs(argattr) | IsWeaponClassifiedAs(argattr1))
            {
            ...
            // 投下型マップ攻撃は効果範囲が広い
            string argattr2 = "Ｍ投";
            max_range = (max_range + WeaponLevel(argattr2));
        ...
        public bool IsTargetWithinRange(Unit t)
        {
            ...
            string argattr1 = "合";
            string argattr2 = "Ｍ";
            if (IsWeaponClassifiedAs(argattr1) & !IsWeaponClassifiedAs(argattr2) & max_range == 1)
            {
