...
//        // 構えている武器の種類
//        private static string WeaponInHand;

//        // 攻撃手段の種類
//        private static string CurrentWeaponType;


//        // 戦闘アニメ再生用サブルーチン
//        public static void ShowAnimation(ref string aname)
//        {
...
//            // サブルーチン呼び出しのための式を作成
//            expr = GeneralLib.LIndex(ref aname, 1);
//            if (Strings.InStr(expr, "戦闘アニメ_") != 1)
//            {
//                expr = "戦闘アニメ_" + GeneralLib.LIndex(ref aname, 1);
//            }
...
//            expr = "Call(`" + expr + "`";
//            var loopTo = GeneralLib.LLength(ref aname);
//            for (i = 2; i <= loopTo; i++)
//                expr = expr + ",`" + GeneralLib.LIndex(ref aname, i) + "`";
//            expr = expr + ")";
...
//        // 武器準備時の特殊効果
//        public static void PrepareWeaponEffect(ref Unit u, short w)
//        {
//            // 右クリック中は特殊効果をスキップ
//            if (GUI.IsRButtonPressed())
//            {
...
//            if (SRC.BattleAnimation)
//            {
//                PrepareWeaponAnimation(ref u, w);
//            }
//            else
//            {
//                PrepareWeaponSound(ref u, w);
//            }
//        }

//        // 武器準備時のアニメーション
//        public static void PrepareWeaponAnimation(ref Unit u, short w)
//        {
...
//            // 武器名から武器の種類を判定
//            wtype = CheckWeaponType(ref wname, ref wclass);
//            if (wtype == "手裏剣")
//            {
...
//            // まずはビーム攻撃かどうか判定
//            if (!IsBeamWeapon(ref wname, wclass, ref cname))
//            {
//                goto SkipBeamWeapon;
//            }
...
//                    }
//                }
//                else if (CountAttack0(ref u, w) >= 4)
//                {
//                    wtype = "マシンガン";
//                }
...
//        // 武器の名称から武器の種類を判定
//        private static string CheckWeaponType(ref string wname, ref string wclass)
//        {
...
//        // 武器準備時の効果音
//        public static void PrepareWeaponSound(ref Unit u, short w)
//        {
//            string wname, wclass;
...
//        // 武器使用時の特殊効果
//        public static void AttackEffect(ref Unit u, short w)
//        {
//            // 右クリック中は特殊効果をスキップ
//            if (GUI.IsRButtonPressed())
//            {
...
//        // 武器使用時のアニメーション
//        public static void AttackAnimation(ref Unit u, short w)
//        {
...
//            var attack_times = default(short);
//            var double_weapon = default(bool);
...
//                        case "黒":
//                            {
//                                cname = SpellColor(ref wname, wclass);
//                                break;
//                            }
//                    }
...
//                    wtype = "中ビーム";
//                }
//                else if (CountAttack0(ref u, w) >= 4 | Strings.InStr(wname, "対空") > 0)
//                {
//                    wtype = "ニードルレーザー連射";
//                }
...
//        // 武器使用時の効果音
//        public static void AttackSound(ref Unit u, short w)
//        {
//            string wname, wclass;
...
//        // 武器命中時の特殊効果
//        public static void HitEffect(ref Unit u, ref short w, ref Unit t, short hit_count = 0)
//        {
...
//            if (SRC.BattleAnimation)
//            {
//                HitAnimation(ref u, w, ref t, hit_count);
//            }
//            else
//            {
//                HitSound(ref u, ref w, ref t, hit_count);
//            }
//        }

//        // 武器命中時のアニメーション
//        public static void HitAnimation(ref Unit u, short w, ref Unit t, short hit_count)
//        {
//            string wtype = default, wname, wclass, wtype0 = default;
...
//                wtype = "ダメージ";
//                if (IsBeamWeapon(ref wname, wclass, ref cname) | Strings.InStr(wname, "ミサイル") > 0 | Strings.InStr(wname, "ロケット") > 0)
//                {
//                    sname = "Explode.wav";
//                }
...
//        // 武器命中時の効果音
//        public static void HitSound(ref Unit u, ref short w, ref Unit t, short hit_count)
//        {
//            string wname, wclass;
//            short num, i;
...
//        // 回避時の効果音
//        public static void DodgeEffect(ref Unit u, ref short w)
//        {
//            string wname, wclass;
//            string sname;
//            wname = u.WeaponNickname(w);
...
//        // 武器切り払い時の効果音
//        public static void ParryEffect(ref Unit u, ref short w, ref Unit t)
//        {
//            string wname, wclass;
//            string sname;
//            short num;
...
//        // 吸収・融合の特殊効果
//        public static void AbsorbEffect(ref Unit u, ref short w, ref Unit t)
//        {
...
//                wclass = withBlock.Class_Renamed;
//            }
...
//            {
//                IsBeamWeapon(ref wname, wclass, ref cname);
//            }
...
//        public static void CriticalEffect(ref string ctype_Renamed, short w, bool ignore_death)
//        {
//            string aname, sname;
//            short i;
...
//            else
//            {
//                var loopTo = GeneralLib.LLength(ref ctype_Renamed);
//                for (i = 1; i <= loopTo; i++)
//                {
//                    aname = GeneralLib.LIndex(ref ctype_Renamed, i) + "クリティカル";
...
//        // 効果音の再生回数を決定
//        private static short CountAttack(ref Unit u, short w, short hit_count = 0)
//        {
//            short CountAttackRet = default;
...
//            if (hit_count > 0 & Strings.InStr(u.Weapon(w).Class_Renamed, "連") > 0)
//            {
//                CountAttackRet = hit_count;
//                return CountAttackRet;
//            }

//            CountAttackRet = (short)GeneralLib.MinLng(CountAttack0(ref u, w), 4);
//            return CountAttackRet;
//        }

//        private static short CountAttack0(ref Unit u, short w)
//        {
//            short CountAttack0Ret = default;
//            string wname, wclass;
//            wname = u.WeaponNickname(w);
//            wclass = u.Weapon(w).Class_Renamed;
...
//        // 魔法の表示色
//        private static string SpellColor(ref string wname, string wclass)
//        {
...
//            // 武器名＆属性に含まれる漢字から判定
//            var loopTo = (short)Strings.Len(sclass);
//            for (i = 1; i <= loopTo; i++)
//            {
...
//        // 破壊アニメーションを表示する
//        public static void DieAnimation(ref Unit u)
//        {
//            short i;
...
//            bool localFileExists() { string argfname = fname + "01.bmp"; var ret = GeneralLib.FileExists(ref argfname); return ret; }
...
//        // 爆発アニメーションを表示する
//        public static void ExplodeAnimation(ref string tsize, short tx, short ty)
//        {
//            short i;
//            var PT = default(GUI.POINTAPI);
//            ;
...
//            {
//                // 爆発用画像のパス
//                bool localFileExists() { string argfname = SRC.ScenarioPath + @"Bitmap\Event\Explode01.bmp"; var ret = GeneralLib.FileExists(ref argfname); return ret; }
...
//        public static void NegateEffect(ref Unit u, ref Unit t, short w, ref string wname, int dmg, ref string fname, ref string fdata, short ecost, ref string msg, bool be_quiet)
//        {
//            var defined = default(bool);
//            if (GeneralLib.LIndex(ref fdata, 1) == "Ｂ" | GeneralLib.LIndex(ref fdata, 2) == "Ｂ" | GeneralLib.LIndex(ref fdata, 3) == "Ｂ")
//            {
//                if (!be_quiet)
//                {
...
//                else if (dmg < 0)
//                {
//                    AbsorbEffect(ref u, ref w, ref t);
//                }
