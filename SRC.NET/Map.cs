...
namespace Project1
{
    static class Map
    {
        ...
        // 管理可能な地形データの総数
        public const short MAX_TERRAIN_DATA_NUM = 2000;

        // ADD START 240a
        // レイヤー無しの固定値
        public const short NO_LAYER_NUM = 10000;
        // ADD  END  240a
        ...
        // (X,Y)地点の命中修正
        public static short TerrainEffectForHit(short X, short Y)
        {
            short TerrainEffectForHitRet = default;
            // MOD START 240a
            // TerrainEffectForHit = TDList.HitMod(MapData(X, Y, 0))
            switch (MapData[X, Y, MapDataIndex.BoxType])
            {
                case (short)BoxTypes.Under:
                case (short)BoxTypes.UpperBmpOnly:
                    {
        ...
        // (X,Y)地点のダメージ修正
        public static short TerrainEffectForDamage(short X, short Y)
        {
            short TerrainEffectForDamageRet = default;
            // MOD START 240a
        ...
        // (X,Y)地点のＨＰ回復率
        public static short TerrainEffectForHPRecover(short X, short Y)
        {
            short TerrainEffectForHPRecoverRet = default;
            // MOD START 240a
                ...
                case (short)BoxTypes.UpperBmpOnly:
                    {
                        ...
                        TerrainEffectForHPRecoverRet = (short)(10d * SRC.TDList.FeatureLevel(MapData[X, Y, MapDataIndex.TerrainType], ref argftype));
                        break;
                    }
                ...
                default:
                    {
                        ...
                        TerrainEffectForHPRecoverRet = (short)(10d * SRC.TDList.FeatureLevel(MapData[X, Y, MapDataIndex.LayerType], ref argftype1));
                        break;
                    }
            }
        ...
        // (X,Y)地点のＥＮ回復率
        public static short TerrainEffectForENRecover(short X, short Y)
        {
            short TerrainEffectForENRecoverRet = default;
            // MOD START 240a
                ...
                case (short)BoxTypes.UpperBmpOnly:
                    {
                        ...
                        TerrainEffectForENRecoverRet = (short)(10d * SRC.TDList.FeatureLevel(MapData[X, Y, MapDataIndex.TerrainType], ref argftype));
                        break;
                    }
                ...
                default:
                    {
                        ...
                        TerrainEffectForENRecoverRet = (short)(10d * SRC.TDList.FeatureLevel(MapData[X, Y, MapDataIndex.LayerType], ref argftype1));
                        break;
                    }
            }
        ...
        // (X,Y)地点の地形名称
        public static string TerrainName(short X, short Y)
        {
        ...
        // (X,Y)地点の地形クラス
        public static string TerrainClass(short X, short Y)
        {
        ...
        // (X,Y)地点の移動コスト
        public static short TerrainMoveCost(short X, short Y)
        {
            short TerrainMoveCostRet = default;
            // MOD START 240a
        ...
        public static bool TerrainHasObstacle(short X, short Y)
        {
        ...
        // ADD START 240a
        // (X,Y)地点が移動停止か
        public static bool TerrainHasMoveStop(short X, short Y)
        {
        ...
        // (X,Y)地点が進入禁止か
        public static bool TerrainDoNotEnter(short X, short Y)
        {
            bool ret;
            switch (MapData[X, Y, MapDataIndex.BoxType])
            {
        ...
        public static bool TerrainHasFeature(short X, short Y, ref string Feature)
        {
        ...
        // (X,Y)地点にいるユニット
        public static Unit UnitAtPoint(short X, short Y)
        {
        ...
        // 指定したマップ画像を検索する
        public static string SearchTerrainImageFile(short tid, short tbitmap, short tx, short ty)
        {
...
#error Cannot convert LocalDeclarationStatementSyntax - see comment for details
        ...
        // マップサイズを設定
        public static void SetMapSize(short w, short h)
        {
            short i, j;
            int ret;
            MapWidth = w;
            MapHeight = h;
            GUI.MapPWidth = (short)(32 * w);
            GUI.MapPHeight = (short)(32 * h);
            GUI.MapX = (short)((GUI.MainWidth + 1) / 2);
            GUI.MapY = (short)((GUI.MainHeight + 1) / 2);
            ...
            MapData = new short[(MapWidth + 1), (MapHeight + 1), 5];
            // MOD  END  240a
        ...
        public static string RestoreMapData()
        {
            ...
            short ibuf1 = default, ibuf2 = default;
            // ADD START 240a
            short ibuf3 = default, ibuf4;
            var buf = default(string);
            // ADD  END  240a
            short i, j;
        ...
        public static void AreaInRange(short X, short Y, short max_range, short min_range, ref string uparty)
        {
            short x1, y1;
            short x2, y2;
            short i, j;
            ...
            x1 = (short)GeneralLib.MaxLng(X - max_range, 1);
            x2 = (short)GeneralLib.MinLng(X + max_range, MapWidth);
            y1 = (short)GeneralLib.MaxLng(Y - max_range, 1);
            y2 = (short)GeneralLib.MinLng(Y + max_range, MapHeight);
            ...
            for (i = x1; i <= loopTo2; i++)
            {
                ...
                {
                    n = (short)(Math.Abs((short)(X - i)) + Math.Abs((short)(Y - j)));
                    if (n <= max_range)
                    {
                        if (n >= min_range)
                        {
        ...
        public static void AreaInReachable(ref Unit u, short max_range, ref string uparty)
        {
            bool[] tmp_mask_data;
            short j, i, k;
            ...
            var loopTo = (short)(MapWidth + 1);
            for (i = 0; i <= loopTo; i++)
            {
                var loopTo1 = (short)(MapHeight + 1);
                for (j = 0; j <= loopTo1; j++)
        ...
        public static void AreaInCross(short X, short Y, short min_range, ref short max_range)
        {
            short i, j;
            var loopTo = MapWidth;
            for (i = 1; i <= loopTo; i++)
            ...
            var loopTo2 = (short)(Y - min_range);
            for (i = (short)(Y - max_range); i <= loopTo2; i++)
            {
                if (i >= 1)
                {
                    MaskData[X, i] = false;
            ...
            var loopTo3 = (short)(Y + max_range);
            for (i = (short)(Y + min_range); i <= loopTo3; i++)
            {
                if (i <= MapHeight)
                {
                    MaskData[X, i] = false;
            ...
            var loopTo4 = (short)(X - min_range);
            for (i = (short)(X - max_range); i <= loopTo4; i++)
            {
                if (i >= 1)
                {
                    MaskData[i, Y] = false;
            ...
            var loopTo5 = (short)(X + max_range);
            for (i = (short)(X + min_range); i <= loopTo5; i++)
            {
                if (i <= MapWidth)
                {
                    MaskData[i, Y] = false;
        ...
        public static void AreaInLine(short X, short Y, short min_range, ref short max_range, ref string direction)
        {
            short i, j;
            var loopTo = MapWidth;
            for (i = 1; i <= loopTo; i++)
        ...
        public static void AreaInWideCross(short X, short Y, short min_range, ref short max_range)
        {
            short i, j;
            var loopTo = MapWidth;
            for (i = 1; i <= loopTo; i++)
            ...
            var loopTo3 = (short)(Y - (min_range + 1));
            for (i = (short)(Y - max_range + 1); i <= loopTo3; i++)
            {
                if (i >= 1)
                {
                    if (X > 1)
            ...
            var loopTo4 = (short)(Y + max_range);
            for (i = (short)(Y + min_range); i <= loopTo4; i++)
            {
                if (i <= MapHeight)
                {
                    MaskData[X, i] = false;
            ...
            var loopTo5 = (short)(Y + max_range - 1);
            for (i = (short)(Y + (min_range + 1)); i <= loopTo5; i++)
            {
                if (i <= MapHeight)
                {
                    if (X > 1)
            ...
            var loopTo6 = (short)(X - min_range);
            for (i = (short)(X - max_range); i <= loopTo6; i++)
            {
                if (i >= 1)
                {
                    MaskData[i, Y] = false;
            ...
            var loopTo7 = (short)(X - (min_range + 1));
            for (i = (short)(X - max_range + 1); i <= loopTo7; i++)
            {
                if (i >= 1)
                {
                    if (Y > 1)
            ...
            var loopTo8 = (short)(X + max_range);
            for (i = (short)(X + min_range); i <= loopTo8; i++)
            {
                if (i <= MapWidth)
                {
                    MaskData[i, Y] = false;
            ...
            var loopTo9 = (short)(X + max_range - 1);
            for (i = (short)(X + (min_range + 1)); i <= loopTo9; i++)
            {
                if (i <= MapWidth)
                {
                    if (Y > 1)
        ...
        public static void AreaInCone(short X, short Y, short min_range, ref short max_range, ref string direction)
        {
            short i, j;
            var loopTo = MapWidth;
            for (i = 1; i <= loopTo; i++)
        ...
        public static void AreaInSector(short X, short Y, short min_range, ref short max_range, ref string direction, short lv, bool without_refresh = false)
        {
            short xx, i, yy;
            if (!without_refresh)
            {
                ...
                case "N":
                    {
                        ...
                        for (i = min_range; i <= loopTo2; i++)
                        {
                            ...
                            switch (lv)
                            {
                                case 1:
                                    {
                                        var loopTo3 = (short)GeneralLib.MinLng(X + i / 3, MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - i / 3, 1); xx <= loopTo3; xx++)
                                ...
                                case 2:
                                    {
                                        var loopTo4 = (short)GeneralLib.MinLng(X + i / 2, MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - i / 2, 1); xx <= loopTo4; xx++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 3:
                                    {
                                        var loopTo5 = (short)GeneralLib.MinLng(X + (i - 1), MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - (i - 1), 1); xx <= loopTo5; xx++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 4:
                                    {
                                        var loopTo6 = (short)GeneralLib.MinLng(X + i, MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - i, 1); xx <= loopTo6; xx++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                            }
                ...
                case "S":
                    {
                        ...
                        for (i = min_range; i <= loopTo7; i++)
                        {
                            ...
                            switch (lv)
                            {
                                case 1:
                                    {
                                        var loopTo8 = (short)GeneralLib.MinLng(X + i / 3, MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - i / 3, 1); xx <= loopTo8; xx++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 2:
                                    {
                                        var loopTo9 = (short)GeneralLib.MinLng(X + i / 2, MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - i / 2, 1); xx <= loopTo9; xx++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 3:
                                    {
                                        var loopTo10 = (short)GeneralLib.MinLng(X + (i - 1), MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - (i - 1), 1); xx <= loopTo10; xx++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 4:
                                    {
                                        var loopTo11 = (short)GeneralLib.MinLng(X + i, MapWidth);
                                        for (xx = (short)GeneralLib.MaxLng(X - i, 1); xx <= loopTo11; xx++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                            }
                ...
                case "W":
                    {
                        ...
                        for (i = min_range; i <= loopTo12; i++)
                        {
                            ...
                            switch (lv)
                            {
                                case 1:
                                    {
                                        var loopTo13 = (short)GeneralLib.MinLng(Y + i / 3, MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - i / 3, 1); yy <= loopTo13; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 2:
                                    {
                                        var loopTo14 = (short)GeneralLib.MinLng(Y + i / 2, MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - i / 2, 1); yy <= loopTo14; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 3:
                                    {
                                        var loopTo15 = (short)GeneralLib.MinLng(Y + (i - 1), MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - (i - 1), 1); yy <= loopTo15; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 4:
                                    {
                                        var loopTo16 = (short)GeneralLib.MinLng(Y + i, MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - i, 1); yy <= loopTo16; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                            }
                ...
                case "E":
                    {
                        ...
                        for (i = min_range; i <= loopTo17; i++)
                        {
                            ...
                            switch (lv)
                            {
                                case 1:
                                    {
                                        var loopTo18 = (short)GeneralLib.MinLng(Y + i / 3, MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - i / 3, 1); yy <= loopTo18; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 2:
                                    {
                                        var loopTo19 = (short)GeneralLib.MinLng(Y + i / 2, MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - i / 2, 1); yy <= loopTo19; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 3:
                                    {
                                        var loopTo20 = (short)GeneralLib.MinLng(Y + (i - 1), MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - (i - 1), 1); yy <= loopTo20; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                                ...
                                case 4:
                                    {
                                        var loopTo21 = (short)GeneralLib.MinLng(Y + i, MapHeight);
                                        for (yy = (short)GeneralLib.MaxLng(Y - i, 1); yy <= loopTo21; yy++)
                                            MaskData[xx, yy] = false;
                                        break;
                                    }
                            }
        ...
        public static void AreaInSectorCross(short X, short Y, short min_range, ref short max_range, short lv)
        {
            short xx, yy;
            var loopTo = MapWidth;
            for (xx = 1; xx <= loopTo; xx++)
        ...
        public static void AreaInPointToPoint(short x1, short y1, short x2, short y2)
        {
            short xx, yy;
            ...
            xx = x1;
            yy = y1;
            if (Math.Abs((short)(x1 - x2)) > Math.Abs((short)(y1 - y2)))
            {
                do
                {
                    if (x1 > x2)
                    ...
                    MaskData[xx, yy] = false;
                    yy = (short)(y1 + (y2 - y1) * (x1 - xx + 0d) / (x1 - x2));
                    MaskData[xx, yy] = false;
                }
                while (xx != x2);
            }
            else
            {
                do
                {
                    ...
                    MaskData[xx, yy] = false;
                    xx = (short)(x1 + (x2 - x1) * (y1 - yy + 0d) / (y1 - y2));
                    MaskData[xx, yy] = false;
                }
                while (yy != y2);
            }
        ...
        public static void AreaInSpeed(ref Unit u, bool ByJump = false)
        {
            ...
            bool blocked;
            {
                ...
                if (ByJump)
                {
                    ...
                    uspeed = (short)(withBlock.Speed + withBlock.FeatureLevel(ref argIndex3));
                }
                else
                {
                ...
                // ２倍にして移動範囲を計算する
                uspeed = (short)(2 * uspeed);

                // ADD START MARGE
                // 再移動時は最初の移動の分だけ移動力を減少させる
                if (Commands.SelectedCommand == "再移動")
                {
                    uspeed = (short)(uspeed - Commands.SelectedUnitMoveCost);
                }
                ...
                // 移動範囲をチェックすべき領域
                x1 = (short)GeneralLib.MaxLng(1, withBlock.x - uspeed);
                y1 = (short)GeneralLib.MaxLng(1, withBlock.y - uspeed);
                x2 = (short)GeneralLib.MinLng(withBlock.x + uspeed, MapWidth);
                y2 = (short)GeneralLib.MinLng(withBlock.y + uspeed, MapHeight);

                // 移動コストとＺＯＣをリセット
                var loopTo2 = (short)(MapWidth + 1);
                for (i = 0; i <= loopTo2; i++)
                {
                    var loopTo3 = (short)(MapHeight + 1);
                    for (j = 0; j <= loopTo3; j++)
                    {
                                        ...
                                        case "宇宙":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo6 = (short)Information.UBound(adopted_terrain);
                                                    for (k = 1; k <= loopTo6; k++)
                                                    {
                                        ...
                                        case "月面":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo9 = (short)Information.UBound(adopted_terrain);
                                                    for (k = 1; k <= loopTo9; k++)
                                                    {
                                                        if ((TerrainName(i, j) ?? "") == (adopted_terrain[k] ?? ""))
                                                        {
                                        ...
                                        case "水":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo10 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "宇宙":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo11 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "月面":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo14 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "宇宙":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo15 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "月面":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo18 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "水":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo19 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "宇宙":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo20 = (short)Information.UBound(adopted_terrain);
                                ...
                                for (j = y1; j <= loopTo22; j++)
                                {
                                    switch (TerrainClass(i, j) ?? "")
                                    {
                                        case "宇宙":
                                            {
                                                move_cost[i, j] = TerrainMoveCost(i, j);
                                                var loopTo23 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "屋内":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo24 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "月面":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo25 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "水":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo26 = (short)Information.UBound(adopted_terrain);
                                        ...
                                        case "空":
                                            {
                                                ...
                                                {
                                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                                    var loopTo27 = (short)Information.UBound(adopted_terrain);
                            ...
                            if (withBlock1.Status == "出撃")
                            {
                                ...
                                if (blocked & !ByJump)
                                {
                                    ...
                                    if (withBlock1.IsFeatureAvailable(ref argfname12) | Expression.IsOptionDefined(ref argoname))
                                    {
                                        ...
                                        n = (short)withBlock1.FeatureLevel(ref argIndex10);
                                        if (n == 1)
                                            n = 10000;

                                        // Option「ＺＯＣ」が指定されている
                                        n = (short)GeneralLib.MaxLng(1, n);
                                        ...
                                        if (u.IsFeatureAvailable(ref argfname11))
                                        {
                                            ...
                                            l = (short)u.FeatureLevel(ref argIndex11);
                                            if (l == 1)
                                                l = 10000;
                                        ...
                                        if (is_zoc)
                                        {
                                            for (i = -1; i <= 1; i++)
                                            {
                                                var loopTo44 = (short)Math.Abs(Math.Abs(i) - 1);
                                                for (j = (short)(Math.Abs(i) - 1); j <= loopTo44; j++)
                                                {
                                                    if ((i != 0 | j != 0) & withBlock1.x + i >= 1 & (short)(withBlock1.x + i) <= MapWidth & withBlock1.y + j >= 1 & (short)(withBlock1.y + j) <= MapHeight)
                                                    {
                                                        // 隣接ユニットが存在する？
                                                        if (MapDataForUnit[(short)(withBlock1.x + i), (short)(withBlock1.y + j)] is object)
                                                        {
                                                            buf = withBlock1.Party0;
                                                            {
                                                                var withBlock2 = MapDataForUnit[(short)(withBlock1.x + i), (short)(withBlock1.y + j)];
                                                                // 敵対陣営？
                                                                ...
                                                                l = (short)withBlock2.FeatureLevel(ref argIndex12);
                                                                if (l == 1)
                                                                    l = 10000;
                                    ...
                                    if (is_zoc)
                                    {
                                        ...
                                        if (GeneralLib.LLength(ref arglist4) >= 2)
                                        {
                                            ...
                                            zarea = (short)GeneralLib.MaxLng(Conversions.ToInteger(localLIndex1()), 0);
                                        }

                                        // 相対距離＋ＺＯＣの範囲が移動力以内のとき、ＺＯＣを設定
                                        if ((short)((short)(Math.Abs((short)(u.x - withBlock1.x)) + Math.Abs((short)(u.y - withBlock1.y))) - zarea) <= uspeed)
                                        {
                                            ...
                                            {
                                                var loopTo45 = zarea;
                                                for (i = (short)(zarea * -1); i <= loopTo45; i++)
                                                {
                                                    if (i == 0)
                                                    {
                                                    ...
                                                    {
                                                        // 水平ＺＯＣ
                                                        if (is_hzoc & withBlock1.x + i >= 1 & (short)(withBlock1.x + i) <= MapWidth)
                                                        {
                                                            if (PointInZOC[(short)(withBlock1.x + i), withBlock1.y] < 0)
                                                            {
                                                                if (n > Math.Abs(PointInZOC[(short)(withBlock1.x + i), withBlock1.y]))
                                                                {
                                                                    PointInZOC[(short)(withBlock1.x + i), withBlock1.y] = n;
                                                                }
                                                            }
                                                            else
                                                            {
                                                                PointInZOC[(short)(withBlock1.x + i), withBlock1.y] = GeneralLib.MaxLng(n, PointInZOC[(short)(withBlock1.x + i), withBlock1.y]);
                                                            }
                                                        }
                                                        // 垂直ＺＯＣ
                                                        if (is_vzoc & withBlock1.y + i >= 1 & (short)(withBlock1.y + i) <= MapHeight)
                                                        {
                                                            if (PointInZOC[withBlock1.x, (short)(withBlock1.y + i)] < 0)
                                                            {
                                                                if (n > Math.Abs(PointInZOC[withBlock1.x, (short)(withBlock1.y + i)]))
                                                                {
                                                                    PointInZOC[withBlock1.x, (short)(withBlock1.y + i)] = n;
                                                                }
                                                            }
                                                            else
                                                            {
                                                                PointInZOC[withBlock1.x, (short)(withBlock1.y + i)] = GeneralLib.MaxLng(n, PointInZOC[withBlock1.x, (short)(withBlock1.y + i)]);
                                                            }
                                                        }
                                                    }
                                                }
                                            ...
                                            else
                                            {
                                                // 全方位ＺＯＣ
                                                var loopTo46 = zarea;
                                                for (i = (short)(zarea * -1); i <= loopTo46; i++)
                                                {
                                                    var loopTo47 = Math.Abs((short)(Math.Abs(i) - zarea));
                                                    for (j = (short)(Math.Abs(i) - zarea); j <= loopTo47; j++)
                                                    {
                                                        if (withBlock1.x + i >= 1 & (short)(withBlock1.x + i) <= MapWidth & withBlock1.y + j >= 1 & (short)(withBlock1.y + j) <= MapHeight)
                                                        {
                                                            if (PointInZOC[(short)(withBlock1.x + i), (short)(withBlock1.y + j)] < 0)
                                                            {
                                                                if (n > Math.Abs(PointInZOC[(short)(withBlock1.x + i), (short)(withBlock1.y + j)]))
                                                                {
                                                                    PointInZOC[(short)(withBlock1.x + i), (short)(withBlock1.y + j)] = n;
                                                                }
                                                            }
                                                            else
                                                            {
                                                                PointInZOC[(short)(withBlock1.x + i), (short)(withBlock1.y + j)] = GeneralLib.MaxLng(n, PointInZOC[(short)(withBlock1.x + i), (short)(withBlock1.y + j)]);
                                                            }
                                                        }
                                                    }
                                                }
                                ...
                                else if ((short)((short)(Math.Abs((short)(u.x - withBlock1.x)) + Math.Abs((short)(u.y - withBlock1.y))) - zarea) <= uspeed)
                                {
                                    // レベル指定なし、またはLv1はLv10000として扱う
                                    object argIndex17 = "広域ＺＯＣ無効化";
                                    l = (short)withBlock1.FeatureLevel(ref argIndex17);
                                    if (l == 1)
                                        l = 10000;
                                    if (l > 0)
                                    {
                                        ...
                                        n = (short)GeneralLib.MaxLng(localStrToLng(), 1);
                                        var loopTo48 = n;
                                        for (i = (short)(n * -1); i <= loopTo48; i++)
                                        {
                                            var loopTo49 = Math.Abs((short)(Math.Abs(i) - n));
                                            for (j = (short)(Math.Abs(i) - n); j <= loopTo49; j++)
                                            {
                                                if (withBlock1.x + i >= 1 & (short)(withBlock1.x + i) <= MapWidth & withBlock1.y + j >= 1 & (short)(withBlock1.y + j) <= MapHeight)
                                                {
                                                    PointInZOC[(short)(withBlock1.x + i), (short)(withBlock1.y + j)] = PointInZOC[(short)(withBlock1.x + i), (short)(withBlock1.y + j)] - l;
                                                }
                                            }
                                        }
                                    }
                ...
                // まず移動コスト計算用の配列を初期化
                var loopTo52 = (short)(MapWidth + 1);
                for (i = 0; i <= loopTo52; i++)
                {
                    var loopTo53 = (short)(MapHeight + 1);
                ...
                {
                    // 現在の必要移動力を保存
                    var loopTo55 = (short)GeneralLib.MinLng(withBlock.x + i + 1, MapWidth + 1);
                    for (j = (short)GeneralLib.MaxLng(0, withBlock.x - i - 1); j <= loopTo55; j++)
                    {
                        var loopTo56 = (short)GeneralLib.MinLng(withBlock.y + i + 1, MapHeight + 1);
                        for (k = (short)GeneralLib.MaxLng(0, withBlock.y - i - 1); k <= loopTo56; k++)
                            cur_cost[j, k] = TotalMoveCost[j, k];
                    }

                    var loopTo57 = (short)GeneralLib.MinLng(withBlock.x + i, MapWidth);
                    for (j = (short)GeneralLib.MaxLng(1, withBlock.x - i); j <= loopTo57; j++)
                    {
                        var loopTo58 = (short)GeneralLib.MinLng(withBlock.y + i, MapHeight);
                        for (k = (short)GeneralLib.MaxLng(1, withBlock.y - i); k <= loopTo58; k++)
                        {
                            ...
                            {
                                {
                                    ...
                                    tmp = GeneralLib.MinLng(tmp, Operators.AddObject(cur_cost[(int)j - 1, (int)k], Interaction.IIf(PointInZOC[(int)j - 1, k] > 0, 10000, 0)));
                                    tmp = GeneralLib.MinLng(tmp, Operators.AddObject(cur_cost[(int)j + 1, (int)k], Interaction.IIf(PointInZOC[(int)j + 1, k] > 0, 10000, 0)));
                                    tmp = GeneralLib.MinLng(tmp, Operators.AddObject(cur_cost[(int)j, (int)k - 1], Interaction.IIf(PointInZOC[j, (int)k - 1] > 0, 10000, 0)));
                                    tmp = GeneralLib.MinLng(tmp, Operators.AddObject(cur_cost[(int)j, (int)k + 1], Interaction.IIf(PointInZOC[j, (int)k + 1] > 0, 10000, 0)));
                                }
                            }
                            else
                ...
                if (ByJump | withBlock.IsFeatureAvailable(ref argfname23) | withBlock.IsUnderSpecialPowerEffect(ref argsptype2))
                {
                    ...
                    for (i = x1; i <= loopTo63; i++)
                    {
                        ...
                        for (j = y1; j <= loopTo64; j++)
                        {
                            ...
                            {
                                var loopTo65 = (short)Information.UBound(allowed_terrains);
                            ...
                            // 進入不可
                            var loopTo66 = (short)Information.UBound(prohibited_terrains);
        ...
        public static void AreaInTeleport(ref Unit u, short lv = 0)
        {
            bool is_trans_available_on_ground;
            bool is_trans_available_in_water;
            var is_trans_available_on_water = default(bool);
            ...
            else
            {
                ...
                r = (short)(u.Speed + u.FeatureLevel(ref argIndex5));
            }
            ...
            // 移動可能な地点を調べる
            var loopTo4 = (short)GeneralLib.MinLng(MapWidth, u.x + r);
            for (i = (short)GeneralLib.MaxLng(1, u.x - r); i <= loopTo4; i++)
            {
                var loopTo5 = (short)GeneralLib.MinLng(MapHeight, u.y + r);
                for (j = (short)GeneralLib.MaxLng(1, u.y - r); j <= loopTo5; j++)
                {
                    // 移動範囲内？
                    if ((short)(Math.Abs((short)(u.x - i)) + Math.Abs((short)(u.y - j))) > r)
                    {
                        goto NextLoop;
                    }
                    ...
                    if (u2 is null)
                    {
                        ...
                        if (Information.UBound(allowed_terrains) > 0)
                        {
                            var loopTo6 = (short)Information.UBound(allowed_terrains);
                            for (k = 2; k <= loopTo6; k++)
                            {
                                if ((TerrainName(i, j) ?? "") == (allowed_terrains[k] ?? ""))
                                {
                        ...
                        // 進入不可
                        var loopTo7 = (short)Information.UBound(prohibited_terrains);
                        for (k = 2; k <= loopTo7; k++)
                        {
                            if ((TerrainName(i, j) ?? "") == (prohibited_terrains[k] ?? ""))
                            {
        ...
        public static void AreaInMoveAction(ref Unit u, short max_range)
        {
            short k, i, j, n;
            // ADD START MARGE
            string buf;
            ...
            // 移動範囲をチェックすべき領域
            x1 = (short)GeneralLib.MaxLng(1, u.x - max_range);
            y1 = (short)GeneralLib.MaxLng(1, u.y - max_range);
            x2 = (short)GeneralLib.MinLng(u.x + max_range, MapWidth);
            y2 = (short)GeneralLib.MinLng(u.y + max_range, MapHeight);
            ...
            for (i = x1; i <= loopTo6; i++)
            {
                ...
                {
                    // 移動力の範囲内？
                    if ((short)(Math.Abs((short)(u.x - i)) + Math.Abs((short)(u.y - j))) > max_range)
                    {
                        goto NextLoop;
                    }
                        ...
                        case "宇宙":
                            {
                                ...
                                if (Information.UBound(allowed_terrains) > 0)
                                {
                                    var loopTo8 = (short)Information.UBound(allowed_terrains);
                                    for (k = 2; k <= loopTo8; k++)
                                    {
                                        if ((TerrainName(i, j) ?? "") == (allowed_terrains[k] ?? ""))
                                        {
                                ...
                                // 進入不可
                                var loopTo9 = (short)Information.UBound(prohibited_terrains);
                                for (k = 2; k <= loopTo9; k++)
                                {
                                    if ((TerrainName(i, j) ?? "") == (prohibited_terrains[k] ?? ""))
                                    {
        ...
        public static bool IsLineBlocked(short x1, short y1, short x2, short y2, bool is_flying = false)
        {
        ...
        public static void NearestPoint(ref Unit u, short dst_x, short dst_y, ref short X, ref short Y)
        {
            short k, i, j, n;
            ...
            // 目的地がマップ外にならないように
            dst_x = (short)GeneralLib.MaxLng(GeneralLib.MinLng(dst_x, MapWidth), 1);
            dst_y = (short)GeneralLib.MaxLng(GeneralLib.MinLng(dst_y, MapHeight), 1);
            ...
            short localLLength() { object argIndex1 = "地形適応"; string arglist = u.FeatureData(ref argIndex1); var ret = GeneralLib.LLength(ref arglist); return ret; }

            adopted_terrain = new string[(localLLength() + 1)];
            var loopTo = (short)Information.UBound(adopted_terrain);
            for (i = 2; i <= loopTo; i++)
            {
                ...
                case "空中":
                    {
                        ...
                        for (i = 1; i <= loopTo1; i++)
                        {
                            ...
                            for (j = 1; j <= loopTo2; j++)
                            {
                                ...
                                {
                                    move_cost[i, j] = TerrainMoveCost(i, j);
                                    var loopTo3 = (short)Information.UBound(adopted_terrain);
                                    for (k = 2; k <= loopTo3; k++)
                                    {
                                        if ((TerrainName(i, j) ?? "") == (adopted_terrain[k] ?? ""))
                                        {
                                    ...
                                    case "水":
                                        {
                                            ...
                                            {
                                                move_cost[i, j] = TerrainMoveCost(i, j);
                                                var loopTo7 = (short)Information.UBound(adopted_terrain);
                                                for (k = 2; k <= loopTo7; k++)
                                                {
                                                    if ((TerrainName(i, j) ?? "") == (adopted_terrain[k] ?? ""))
                                                    {
                                    ...
                                    case "月面":
                                        {
                                            ...
                                            {
                                                move_cost[i, j] = TerrainMoveCost(i, j);
                                                var loopTo13 = (short)Information.UBound(adopted_terrain);
                ...
                case "宇宙":
                    {
                        ...
                        for (i = 1; i <= loopTo15; i++)
                        {
                            ...
                            {
                                move_cost[i, j] = TerrainMoveCost(i, j);
                                var loopTo17 = (short)Information.UBound(adopted_terrain);
            ...
            var loopTo34 = (short)(MapWidth + 1);
            for (i = 0; i <= loopTo34; i++)
            {
                var loopTo35 = (short)(MapHeight + 1);
            ...
            do
            {
                ...
                is_changed = false;
                var loopTo36 = (short)(MapWidth + 1);
                for (j = 0; j <= loopTo36; j++)
                {
                    var loopTo37 = (short)(MapHeight + 1);
                    for (k = 0; k <= loopTo37; k++)
                        cur_speed[j, k] = total_cost[j, k];
                }

                min_x = (short)GeneralLib.MaxLng(1, dst_x - i);
                max_x = (short)GeneralLib.MinLng(dst_x + i, MapWidth);
                var loopTo38 = max_x;
                for (j = min_x; j <= loopTo38; j++)
                {
                    min_y = (short)GeneralLib.MaxLng(1, dst_y - (short)(i - Math.Abs((short)(dst_x - j))));
                    max_y = (short)GeneralLib.MinLng(dst_y + (short)(i - Math.Abs((short)(dst_x - j))), MapHeight);
                    var loopTo39 = max_y;
                ...
                // 最短経路を発見した
                if (total_cost[X, Y] <= Math.Abs((short)(dst_x - X)) + Math.Abs((short)(dst_y - Y)) + 2)
                {
                    break;
                }
            }
                ...
                for (j = 1; j <= loopTo41; j++)
                {
                    if (!MaskData[i, j])
                    {
                        if (MapDataForUnit[i, j] is null)
                        {
                            ...
                            {
                                if (Math.Pow(Math.Abs((short)(dst_x - i)), 2d) + Math.Pow(Math.Abs((short)(dst_y - j)), 2d) < Math.Pow(Math.Abs((short)(dst_x - X)), 2d) + Math.Pow(Math.Abs((short)(dst_y - Y)), 2d))
                                {
                                    X = i;
                                    Y = j;
                                }
        ...
        public static void SafetyPoint(ref Unit u, ref short X, ref short Y)
        {
            short i, j;
            var total_cost = new int[52, 52];
            var cur_cost = new int[52, 52];
                ...
                for (j = 1; j <= loopTo7; j++)
                {
                    if (!MaskData[i, j])
                    {
                        if (MapDataForUnit[i, j] is null)
                        {
                            ...
                            {
                                if (Math.Pow(Math.Abs((short)(u.x - i)), 2d) + Math.Pow(Math.Abs((short)(u.y - j)), 2d) < Math.Pow(Math.Abs((short)(u.x - X)), 2d) + Math.Pow(Math.Abs((short)(u.y - Y)), 2d))
                                {
                                    X = i;
                                    Y = j;
                                }
        ...
        public static void SearchMoveRoute(ref short tx, ref short ty, ref short[] move_route_x, ref short[] move_route_y)
        {
            short xx, yy;
            short nx, ny;
            short ox = default, oy = default;
            int tmp;
            short i;
            string direction = default, prev_direction = default;
            object[] move_direction;
            move_route_x = new short[2];
            move_route_y = new short[2];
            ...
            while (TotalMoveCost[xx, yy] > 0)
            {
                ...
                // 座標軸方向に優先して移動させる
                if (Math.Abs((short)(xx - ox)) <= Math.Abs((short)(yy - oy)))
                {
                    if (TotalMoveCost[xx, yy - 1] < tmp & PointInZOC[xx, yy - 1] <= 0)
                    {
                        tmp = TotalMoveCost[xx, yy - 1];
            ...
            var loopTo2 = (short)(Information.UBound(move_direction) - 1);
            for (i = 2; i <= loopTo2; i++)
            {
                ...
                Commands.MovedUnitSpeed = (short)(Commands.MovedUnitSpeed + 1);
            }
        }
    }
}