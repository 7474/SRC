...
namespace Project1
{
    internal class LabelData
    {
        ...
        public bool Enable;
        // アスタリスクの指定状況
        public short AsterNum;

        // ラベル全体
        private string StrData;
        // ラベルの個数
        private short intParaNum;
        // ラベルの各パラメータ
        ...
        // パラメータの個数
        public short CountPara()
        {
            short CountParaRet = default;
            CountParaRet = intParaNum;
            return CountParaRet;
        }

        // ラベルの idx 番目のパラメータ
        public string Para(short idx)
        {
        ...
        public string Data
        {
            ...
            set
            {
                ...
                var loopTo = (int)intParaNum;
                for (i = 2; i <= loopTo; i++)
                {
                    strParas[i] = GeneralLib.ListIndex(ref value, (short)i);
                    // パラメータが固定値かどうか判定
