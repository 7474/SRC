...
[**Exec**コマンド](Execコマンド.md)現在のイベントデータファイルを終了し、指定したイベントデータファイルを実行する
...
[**PaintSysString**コマンド](PaintSysStringコマンド.md)ダメージ等のシステム情報用の文字列を描画
...
[**CallIntermissionCommand**コマンド](CallIntermissionCommandコマンド.md)本体に実装されたインターミッションコマンドの機能を呼び出す
...
[**SaveData**コマンド](SaveDataコマンド.md)データをセーブする
